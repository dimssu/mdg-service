...
export const VIDEOS = [
  ...
  },
  {
    ...
    audience: 'admin',
    // Nobody hitting this problem will search for "manual shift data" — they will
    // search for the dealer who has no portal, or for the thing that is missing:
    // no data, nothing collected, cannot generate. Romanised Hindi for the same
    // reason it is everywhere else: people type whatever reaches their fingers.
    keywords: [
      'admin',
      'team',
      '16e',
    ...
    hi: {
      ...
      subtitle: 'शिफ़्ट का डेटा हाथ से भरकर रिपोर्ट बनाना',
      description:
        'कुछ डीलरों का IRAS पोर्टल हमारे पास नहीं होता — उनका डेटा अपने आप नहीं आता, फिर भी उन्हें रोज़ वही DSR रिपोर्ट चाहिए। इस वीडियो में — Data Vault से उस दिन को खोलना, \'Start this day by hand\' दबाना, फिर डीलर की अपनी शीट देखकर हर नोज़ल की रीडिंग, हर टैंक की डिप और स्टॉक, और टैंकर की एंट्री भरना; Review और Apply; और आख़िर में उसी तारीख़ के लिए Generate दबाकर रिपोर्ट बनाना।',
      chapters: {
        intro: 'कुछ डीलरों का पोर्टल नहीं होता',
        normal: 'बाक़ी डीलरों में क्या होता है',
        gap: 'यहाँ दिन ख़ाली रह जाता है',
        nav: 'Data Vault → IRAS Shift Data',
        empty: "'Start this day by hand'",
        opened: 'तीन ख़ाली तालिकाएँ',
        tot: 'पंप की रीडिंग भरिए',
        stk: 'टैंक का स्टॉक भरिए',
        rec: 'टैंकर आया हो तो',
        review: 'Review और Apply',
        generate: "उसी तारीख़ का 'Generate'",
        report: 'रिपोर्ट तैयार',
        rules: 'दो ज़रूरी बातें',
        recap: 'छह क़दम — दोहराइए',
      },
    },
    en: {
      title: 'A DSR for an outlet with no portal',
      subtitle: 'Type the shift in by hand, then generate the report',
      description:
        'Some outlets have no IRAS portal account of their own, so nothing arrives on its own — and they still need the same daily report as everyone else. This walkthrough covers opening that day from the Data Vault, pressing "Start this day by hand", and typing the shift in from the dealer\'s own sheet: a row per nozzle reading, a row per tank\'s dip and stock, and any tanker that came. Then Review, Apply, and Generate the report for that date. Two things it stresses: a figure you type is used exactly as typed, and every nozzle and every tank needs its own row. Hindi narration.',
      chapters: {
        intro: 'Why some outlets have no portal',
        normal: 'How it works for everyone else',
        gap: 'Here the day just stays empty',
        nav: 'Data Vault → IRAS Shift Data',
        empty: 'Start this day by hand',
        opened: 'Three empty tables',
        tot: 'Enter the nozzle readings',
        stk: 'Enter each tank’s stock',
        rec: 'If a tanker came',
        review: 'Review and Apply',
        generate: 'Generate for that date',
        report: 'The finished report',
        rules: 'Two things to remember',
        recap: 'Six steps, recapped',
      },
    },
  },
  {
    ...
    hi: {
      ...
      description:
        'हर बार जो शीट WhatsApp पर आती है, वह एक ही सवाल पूछती है — किताब के हिसाब से जितना तेल टंकी में होना चाहिए, उतना है या नहीं। इस वीडियो में तीन लाइनें पढ़ना सीखिए: फ़र्क़ कितना है, छूट कितनी बनती है, और सीमा से बाहर कितना बचा। साथ में — छूट बनती कैसे है, माइनस और प्लस में फ़र्क़ क्या है, और शीट के नीचे लिखी सलाह पर करना क्या है।',
      chapters: {
        intro: 'यह शीट पूछती क्या है',
        blocks: 'ऊपर डीज़ल, नीचे पेट्रोल',
        date: 'हिसाब किस दिन तक का है',
        variation: 'फ़र्क़ कितना है',
        permissible: 'छूट कितनी मिलती है',
        'band-rule': 'छूट बनती कैसे है',
        'not-within': 'सीमा से बाहर कितना',
        advice: 'अब करना क्या है',
        stake: 'टालिए मत — क्यों',
        totals: 'सबसे नीचे की दो लाइनें',
        ms: 'पेट्रोल वाला हिस्सा',
        'ms-ok': 'यह सीमा के अंदर है',
        recap: 'हर बार यही तीन लाइनें',
      },
    },
    en: {
      title: 'Reading the stock variation sheet',
      subtitle: 'Making sense of the stock sheet that arrives on WhatsApp',
      description:
        'The sheet asks one question: is there as much fuel in the tank as the books say there should be? This video teaches the three lines that answer it — how big the difference is, how much allowance you get, and how much is left outside the limit. It also covers where the allowance comes from, why a minus and a plus mean completely different things, and what the advice box at the bottom is actually asking you to do. Hindi narration.',
      chapters: {
        intro: 'What the sheet is asking',
        blocks: 'Diesel on top, petrol below',
        date: 'What date it is counted to',
        variation: 'How big the difference is',
        permissible: 'How much allowance you get',
        'band-rule': 'Where the allowance comes from',
        'not-within': 'How much is outside the limit',
        advice: 'What to do about it',
        stake: "Why it can't wait",
        totals: 'The two lines at the bottom',
        ms: 'The petrol half',
  ...
  },
  {
    ...
    audience: 'public',
    keywords: [
      'about', 'mdg', 'kavach', 'what is', 'services', 'intro', 'film',
      'marketing', 'डीलर कवच', 'परिचय', 'क्या है', 'सेवाएँ', 'फ़िल्म',
    ],
    hi: {
      title: 'डीलर कवच — पूरी कहानी',
      subtitle: 'पंप चलाने का बोझ, और उसका हल',
      description:
        'डेढ़ मिनट में पूरी बात — पंप पर रोज़ जो चीज़ें छूट जाती हैं, और MDG सर्विसेज़ उन्हें कैसे सँभालती है। यह वीडियो किसी को भी भेजा जा सकता है।',
      chapters: {
        'gate-not-ready': 'गेट पर गाड़ी, कागज़ अधूरे',
        'one-wrong-figure': 'एक ग़लत आँकड़ा',
        'photo-on-whatsapp': 'WhatsApp पर एक फोटो',
        'anyone-can-copy': 'नक़ल कोई भी कर सकता है',
        'this-is-kavach': 'यही है डीलर कवच',
        'forty-five-items': 'पैंतालीस काम',
        'records-ready': 'रिकॉर्ड तैयार',
        'stock-and-density': 'स्टॉक और डेंसिटी',
        'twenty-two-dates': 'बाईस तारीख़ें',
        'sunday-night': 'रविवार की रात',
        'dod-by-morning': 'सुबह तक बकाया',
        'credit-and-dod': 'क्रेडिट और DOD',
        'one-phone-call': 'एक फ़ोन कॉल',
        'not-a-minute': 'एक मिनट भी नहीं',
        'nine-to-nine': 'नौ से नौ',
      },
    },
    en: {
      title: 'Dealer Kavach — the whole story',
      subtitle: 'What running a pump costs you, and what we do about it',
      description:
        'The whole thing in ninety seconds: what slips through the cracks at a pump every day, and how MDG Services picks it up. Made to be forwarded. Hindi narration.',
      chapters: {
        'gate-not-ready': 'A tanker at the gate, papers short',
        'one-wrong-figure': 'One wrong figure',
        'photo-on-whatsapp': 'A photo on WhatsApp',
        'anyone-can-copy': 'Anyone can copy it',
        'this-is-kavach': 'This is Dealer Kavach',
        'forty-five-items': 'Forty-five items',
        'records-ready': 'Records ready',
        'stock-and-density': 'Stock and density',
        'twenty-two-dates': 'Twenty-two dates',
        'sunday-night': 'Sunday night',
        'dod-by-morning': 'Dues by morning',
        'credit-and-dod': 'Credit and DOD',
        'one-phone-call': 'One phone call',
        'not-a-minute': 'Not a minute of yours',
  ...
  },
  {
    ...
    hi: {
      title: 'डीलर कवच — अंग्रेज़ी में',
      subtitle: 'वही फ़िल्म, अंग्रेज़ी आवाज़ में',
      description:
        'ऊपर वाली फ़िल्म का अंग्रेज़ी संस्करण — वही चित्र, आवाज़ अंग्रेज़ी में।',
      chapters: {
        'gate-not-ready': 'गेट पर गाड़ी, कागज़ अधूरे',
        'one-wrong-figure': 'एक ग़लत आँकड़ा',
        'photo-on-whatsapp': 'WhatsApp पर एक फोटो',
    ...
    en: {
      title: 'Dealer Kavach — in English',
      subtitle: 'The same film, narrated in English',
      description:
        'The English cut of the film above: the same pictures, narrated in English.',
      chapters: {
        'gate-not-ready': 'A tanker at the gate, papers short',
        'one-wrong-figure': 'One wrong figure',
        'photo-on-whatsapp': 'A photo on WhatsApp',
