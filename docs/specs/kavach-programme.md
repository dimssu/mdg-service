...
2. **Daily-item reminder hours:** confirm the local time window for daily nudges (we've assumed ~8am for "before 10am" tasks). Need the dealer's timezone/working hours.
